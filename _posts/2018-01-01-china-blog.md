...
images:
    ...
    - image_path: /img/TeachingChina/Baskets.jpeg
      image_name: Baskets
      text: Most of the games we played were in two teams since children at this age really like to compete. If the children can read the flashcard correctly they get a try at throwing the ball in their basket, at the end of the game we count the balls in the baskets and the team with more scores wins. 
      image_number: 3
    ...
    - image_path: /img/TeachingChina/RoundAndRound.JPG
      ...
      text: Flashcards going round and round, when the music stops the kids who holds them has to read them. 
      image_number: 22
    ...
    - image_path: /img/TeachingChina/Switch.JPG
      ...
      text: The name of this game is 'Switch', it is a bit similar to 'Musical chairs'. Children would stand in two lines next to the chairs and read the flashcards I am showing them. When I say 'Swich' they would run to the opposite line and sit on a chair. Of course there was always one chair missing and a kid without it would leave the game. 
      image_number: 24
    - image_path: /img/TeachingChina/Teacher1.JPG
      image_name: Teachers' board in one of the scools. 
      text: Teachers' board in one of the schools. I was always the strange one, not only because of my race. 
      image_number: 25
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I worked both in kindergartens (ages 3 to 6) and private schools (ages 8 to 15). Since it’s a luxury to have a foreign teacher, I worked in different schools every day. Imagine hundreds of students you only get to see once a week, changing schools every day which already is a pain in the ass, adapting to a different way of working every day.  
